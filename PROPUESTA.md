...
## Usuario Objetivo
Habitantes de barrios y cominidades que deseen conocer el horario de recolección de basura y reporta inconvenientes relacionados con el servicio.

## Problema que Resuelve
La aplicación busca solucionar la falta de información sobre los recorridos y horarios del carro recolector, además de mejorar la gestion de quejas y reclamos para brindar un servicio más eficiente y organizado.

## Páginas Principales que imaginamos
Página de inicio
Pagina de consulta de horarios y recorridos
Formulario de quejas y reclamos
Listado e historial de solicitudes
Panel de administración
Página de seguimiento de respuestas
